...
methodology, with DeepSpatial treated as an aspirational large-scale prior-art
reference rather than a reproduced result~\cite{Yang2026DeepSpatial}.
...
synthetic graphs; the DeepSpatial \S2.5 BRCA-IMC vascular demo waits
...
Spearman panel on the ABC mouse-brain section ladder (Day~8). The
39-million-cell whole-atlas reconstruction reported by DeepSpatial \S2.5
is cited rather than reproduced~\cite{Yang2026DeepSpatial}; we scale gradually section by section
