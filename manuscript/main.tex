...
depths the imager did not capture. Prior art spans alignment-only
...
methodology. \textsc{Aether3D} builds on entropic optimal
...
descriptors~\cite{Edelsbrunner2010PersistentHomology}; the data plumbing
...
is cited rather than reproduced; we scale gradually section by section
