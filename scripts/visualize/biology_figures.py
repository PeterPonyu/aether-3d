...
Runs in three modes:
  ...
  real       auto-detect data/baselines/deepspatial/merfish_mouse_hypothalamus/
...
BASELINE_ROOT = PROJECT_ROOT.parent / "data" / "baselines" / "deepspatial" / "merfish_mouse_hypothalamus"
