...
DEFAULT_DATA_DIR = (
    ...
    "data/baselines/deepspatial/merfish_mouse_hypothalamus"
)
...
def evaluate_holdout(virtual_slice, held_slice, seed=42, n_domains=5):
    ...
    DeepSpatial-style geometry + molecular + topology metrics are appended.
    ...
    # C. DeepSpatial-style geometry + molecular metrics (self-supervised:
...
def main(args: argparse.Namespace) -> None:
    ...
    # Full per-holdout metric inventory (headline + DeepSpatial-style suite).
    PER_SLICE_KEYS = (
